                    ...
                    try {
                        ...
                        if (result.matched) {
                            ...
                            if (existingBuilding) {
                                ...
                                if (typeof ownerBuildings !== 'undefined' && !ownerBuildings) ownerBuildings = [];
                                if (typeof ownerBuildings !== 'undefined') ownerBuildings.push(...insertedData);
                            }
...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === 'GET' && (parsedUrl.pathname === '/' || parsedUrl.pathname === '/index.html' || parsedUrl.pathname === '/admin')) {
    ...
    if (parsedUrl.pathname === '/admin') {
      content = content.replace('</head>', '<script>window.IS_ADMIN_ROUTE = true;