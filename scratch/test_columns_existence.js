...
const columnsToTest = [
    'broker_name', 'broker_phone', 'broker_address', 'broker_reg_no', 'broker_registration_no',
    'broker_agency_name', 'broker_rep_name', 'realtor_name', 'realtor_phone', 'realtor_address',
    'realtor_reg_no', 'realtor_agency_name', 'realtor_representative'
];

async function testFetch() {
    console.log('\n--- Finding which columns exist in contracts table ---');
