...
// 1. Replace the inner div of contract confirm modal with a form
...
// 2. Add OCR Logic and submitContractDetails
const oldFunc = `        function confirmContractSave() {`;
...
code = code.replace(oldFunc, newFuncs);

// Check if successful
if (code.includes('activeOcrTargetInput')) {
    console.log('UI/OCR integration injected successfully!');
} else {
    console.error('Failed to inject UI/OCR logic');
}
